...
%		\hspace*{-0.2in}
		...
		\caption{Un classico esempio dove un peer riceve una parola da un altro peer, e la comunica al GameTable. Successivamente il WordAck, che giunge al peer, fa cambiare il turno, permettendo al giocatore locale di giocare ed inserire una nuova parola. Tale parola viene inviata dal peer al peer successivo.}
		\label{fig:sequence1}
\end{figure}	
