...
Al momento del raggiungimento delle $N$ richieste, il registrar manda ad ogni giocatore la lista degli utenti che parteciperanno alla partita. Tale lista è ordinata ed identica per tutti, stabilendo quindi quale sarà l'ordine con il quale avverranno i turni.

Da questo momento ogni giocatore invia un messaggio di \textit{hello} che stabilisce quando tutti i giocatori sono pronti per poter cominciare la partita.
